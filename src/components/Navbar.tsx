export function Navbar() {
  return (
    <>
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a]/90 backdrop-blur-md border-b border-card">
    ...
    <a
      href="https://wa.me/5591984339322?text=Olá!%20Vim%20pelo%20site%20da%20Reeb%20Synapse%20e%20gostaria%20de%20mais%20informações."
      target="_blank"
